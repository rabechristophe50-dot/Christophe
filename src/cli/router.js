...
function printHelp() {
  console.log('Usage: kasper <command> [options]\n');
  ...
  console.log('\nRun "kasper <command> --help" for command-specific options.');
  console.log('\nDISCLAIMER');
...
export async function run(argv) {
  ...
  if (!cmd) {
    ...
    console.error('Run "kasper --help" for a list of commands.');
    process.exit(1);
  }
  ...
  if (cmd.subcommands) {
    ...
    try {
      ...
      if (values.help) {
        console.log(`Usage: kasper ${cmdName} ${subName} [options]\n`);
