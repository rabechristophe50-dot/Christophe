//+------------------------------------------------------------------+
//|                                          PureScalperEA_Gold.mq5   |
//|              Expert Advisor de Scalping Pur pour l'OR - 100% Auto |
//|                                                                  |
//|  Version calibree XAUUSD (Gold). 1 pip = 0.01 $ (1 cent).        |
...
//+------------------------------------------------------------------+
#property copyright "PureScalperEA Gold"
#property version   "1.00"
#property strict
#property description "Scalping automatique pour l'OR (XAUUSD M5). Valeurs par defaut calibrees Gold."
...
input string   InpComment          = "PureScalperGold"; // Commentaire des ordres
...
input double   InpATRMinPips       = 80.0;        // ATR minimum en pips (or : 80 pips = 0.80 $)
...
input double   InpMaxSpreadPips    = 40.0;        // Spread max autorise (or : 40 pips = 0.40 $)
